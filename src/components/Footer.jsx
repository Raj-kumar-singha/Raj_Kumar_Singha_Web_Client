...
import { BsChevronDoubleUp, BsCupStraw, BsFacebook, BsInstagram, BsTwitterX, BsWhatsapp, BsYoutube } from "react-icons/bs";
        ...
        <footer className=" py-10 px-5">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="flex flex-col items-center">
                    <b className="text-lg mb-4">Follow Us</b>
                ...
                <div className="text-center md:text-left">
                    <b className="text-lg mb-2">Newsletter</b>
